...
//{
//    timer->stop();
//    QString filename = QFileDialog::getOpenFileName(this, tr("Choose"), "", tr("Images(*.png *.jpg *.jprg *.bmp *.gif)"));
...
//        if(valid){
//            image = image.scaledToWidth(ui->display1->width(), Qt::SmoothTransformation);
//            ui->display1->setPixmap(QPixmap::fromImage(image));
//        } else{
